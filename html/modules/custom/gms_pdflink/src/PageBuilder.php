 ...
 */
class PageBuilder implements PrintBuilderInterface {
  ...
  protected function prepareRenderer(array $entities, PrintEngineInterface $print_engine, $use_default_css) {
   ...
   // dump('entity_print__' . $first_entity->getEntityTypeId() . '__' . $first_entity->bundle());exit();
    $render = [
      '#theme' => 'page_print__' . $first_entity->getEntityTypeId() . '__' . $first_entity->bundle(),
