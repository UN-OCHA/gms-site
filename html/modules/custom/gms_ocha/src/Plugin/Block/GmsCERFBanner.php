 ...
 *
 * @Block(
 *  id = "gms_ocha_cerf_banner",
 *  admin_label = @Translation("GMS Ocha CERF Banner")
 * )
 */
class GmsCERFBanner extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $welcometext = $this->t('Welcome to the CERF Help portal');
